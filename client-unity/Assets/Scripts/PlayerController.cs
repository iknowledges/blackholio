  ...
  public void Update()
    {
        ...
        if (Keyboard.current != null && Keyboard.current.qKey.wasPressedThisFrame)
        {
            ...
            else
            {
                ...
                LockInputPosition = Mouse.current != null ? Mouse.current.position.ReadValue() : Vector2.zero;
            }
        }
        ...
        if (Time.time - LastMovementSendTimestamp >= SEND_UPDATES_FREQUENCY)
        {
            ...
            var currentMousePos = Mouse.current != null ? Mouse.current.position.ReadValue() : Vector2.zero;
            var mousePosition = LockInputPosition ?? currentMousePos;
